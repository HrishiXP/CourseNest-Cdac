...
import com.example.CourseNest.annotations.FutureOrToday;
...
public class Workshop {
    ...
    @Pattern(regexp = "^(https://meet\\.google\\.com/|https://zoom\\.us/).*$", message = "Invalid external link. Only Google Meet or Zoom links are allowed.")
