...
public class AuthService {
    ...
    public void checkUserOwnership(long userId) {
        ...
        // Check if the authenticated user's email matches the email of the user being
        // accessed
    ...
    public void checkCreatorOwnership(long creatorId) {
        ...
        // Check if the authenticated user's email matches the email of the creator
        // being accessed
        if (!creator.getEmail().equals(authenticatedEmail)) {
            throw new RuntimeException(
                    "Access Denied: You are not allowed to access or modify this creator's details.");
        }
    }
}
